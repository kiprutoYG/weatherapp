    ...
    style={{backgroundImage: `url(${require("./clouds.jpg")})`, height: '700px', opacity: '0.7'}}>
        <div className="absolute top-auto bg-accent opacity-80 rounded-2xl h-fit flex flex-col flex-grow">
            ...
            <div className="flex justify-center">
                ...
                <button onClick={onCurrentLocation } className="bg-try text-white text-center px-6 py-2 rounded-lg hover:bg-blue-800 align-middle mt-2 sm:text-sm md:text-lg">Use My Location</button>
            </div>
        </div>
    </section>
);
