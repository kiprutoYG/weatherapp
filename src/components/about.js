const About = () => (
    <section id="about" className="bg-accent bg-opacity-60 text-white pt-14">
      <div className="container mx-auto text-center">
        <h2 className="text-4xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-purple-500 animate-fadeIn hover:scale-105 transition-transform">About WeatherNow</h2>
